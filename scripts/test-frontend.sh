...
## Coverage Reports
$([ -d "test-results/frontend/coverage" ] && echo "- Coverage Report: [HTML Report](coverage/index.html)" || echo "- Coverage: Not available")
$([ -f "test-results/frontend/coverage/lcov.info" ] && echo "- LCOV Coverage: [LCOV File](coverage/lcov.info)" || echo "- LCOV Coverage: Not available")

## Code Quality
$([ -f "test-results/frontend/eslint-report.json" ] && echo "- ESLint Report: [JSON Report](eslint-report.json)" || echo "- ESLint: Not run")
$([ -f "test-results/frontend/typescript-report.txt" ] && echo "- TypeScript Check: [Report](typescript-report.txt)" || echo "- TypeScript: Not run")
