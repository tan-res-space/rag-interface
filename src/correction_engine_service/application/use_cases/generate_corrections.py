...
class GenerateCorrectionsUseCase:
    ...
    async def execute(self, request: CorrectionRequest) -> CorrectionResponse:
        ...
        return self._create_response(
            request.text, final_suggestions, processing_time, request.correction_mode
        )

    def _filter_by_correction_mode(
        self, suggestions: List[CorrectionSuggestion], mode
    ...
    def _limit_and_sort_suggestions(
        self, suggestions: List[CorrectionSuggestion], max_suggestions: int
    ) -> List[CorrectionSuggestion]:
        """
