...
class SearchErrorsUseCase:
    ...
    def _generate_cache_key(self, request: SearchErrorsRequest) -> str:
        ...
        search_params = {
            "filters": {
                ...
                "date_from": request.filters.date_from.isoformat() if request.filters.date_from else None,
                "date_to": request.filters.date_to.isoformat() if request.filters.date_to else None,
    ...
    def _create_response_from_cache(self, cached_data: Dict[str, Any]) -> SearchErrorsResponse:
        """
