...
class ErrorValidationModel(Base):
    ...
    is_valid = Column(String(10), nullable=False)  # Using string for boolean compatibility
...
class ErrorCategoryModel(Base):
    ...
    is_active = Column(String(10), nullable=False, default="true")  # Using string for boolean compatibility
