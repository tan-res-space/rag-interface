...
class Settings:
    ...
    def __init__(self):
        ...
        self.ml_models = {
            ...
            "local": {
                "model_path": os.getenv(
                    "LOCAL_MODEL_PATH", "/models/sentence-transformer"
                ),
        ...
        self.vector_db = {
            ...
            "qdrant": {
                ...
                "collection_name": os.getenv(
                    "QDRANT_COLLECTION_NAME", "asr_embeddings"
                ),
        ...
        self.redis = {
            ...
            ),  # Different DB from Error Reporting
        ...
        self.kafka = {
            ...
            "consumer_group": os.getenv(
                "KAFKA_CONSUMER_GROUP", "rag-integration-service"
            ),
            "producer_config": {
        ...
        self.processing = {
            ...
            "pattern_analysis_window_days": int(
                os.getenv("PATTERN_ANALYSIS_WINDOW_DAYS", "30")
            ),
            "quality_metrics_window_days": int(
                os.getenv("QUALITY_METRICS_WINDOW_DAYS", "7")
            ),
        }
