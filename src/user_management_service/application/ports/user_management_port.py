...
class IUserManagementPort(ABC):
    ...
    @abstractmethod
    async def update_user(self, user_id: str, request: UpdateUserRequest) -> UpdateUserResponse:
        """
    ...
    @abstractmethod
    async def change_user_roles(self, request: ChangeUserRolesRequest) -> ChangeUserRolesResponse:
        """
        Change user roles.
    ...
    @abstractmethod
    async def change_user_status(self, request: ChangeUserStatusRequest) -> ChangeUserStatusResponse:
        """
    ...
    @abstractmethod
    async def delete_user(self, user_id: str, deleted_by: str, reason: Optional[str] = None) -> bool:
        """
    ...
    @abstractmethod
    async def get_user_audit_log(self, request: GetUserAuditLogRequest) -> PaginatedAuditLogResponse:
        """
    ...
    @abstractmethod
    async def get_user_security_status(self, user_id: str) -> UserSecurityStatusResponse:
        """
    ...
    @abstractmethod
    async def search_users(self, search_term: str, limit: int = 20) -> List[UserResponse]:
        """
    ...
    @abstractmethod
    async def bulk_update_users(self, user_ids: List[str], updates: dict, updated_by: str) -> dict:
        """
