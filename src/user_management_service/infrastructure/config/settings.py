...
class Settings(BaseModel):
    ...
    def from_env(cls) -> "Settings":
        ...
        event_bus_config = EventBusConfig(
            ...
            bootstrap_servers=os.getenv("UMS_KAFKA_BOOTSTRAP_SERVERS", "localhost:9092"),
        ...
        auth_config = AuthConfig(
            ...
            access_token_expire_minutes=int(os.getenv("UMS_ACCESS_TOKEN_EXPIRE_MINUTES", "30")),
            refresh_token_expire_days=int(os.getenv("UMS_REFRESH_TOKEN_EXPIRE_DAYS", "7")),
        ...
        security_config = SecurityConfig(
            max_failed_login_attempts=int(os.getenv("UMS_MAX_FAILED_LOGIN_ATTEMPTS", "5")),
            account_lockout_duration_minutes=int(os.getenv("UMS_ACCOUNT_LOCKOUT_DURATION_MINUTES", "30")),
            ...
            require_password_change_days=int(os.getenv("UMS_REQUIRE_PASSWORD_CHANGE_DAYS", "90"))
        )
        ...
        return cls(
            ...
            error_reporting_service_url=os.getenv("ERROR_REPORTING_SERVICE_URL", "http://localhost:8001"),
            rag_integration_service_url=os.getenv("RAG_INTEGRATION_SERVICE_URL", "http://localhost:8002"),
            correction_engine_service_url=os.getenv("CORRECTION_ENGINE_SERVICE_URL", "http://localhost:8003"),
            verification_service_url=os.getenv("VERIFICATION_SERVICE_URL", "http://localhost:8004")
        )
