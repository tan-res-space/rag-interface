...
class SERMetrics:
    ...
    def _validate_percentages(self) -> None:
        ...
        percentages = [
            ...
            self.move_percentage,
            self.edit_percentage,
            self.quality_score,
        ]
        ...
        for percentage in percentages:
            ...
            if percentage > 200 and percentage != self.ser_score:
                raise ValueError(
                    f"Percentage value {percentage} seems unreasonably high"
                )
    ...
    def has_significant_improvements_over(
        self, other: "SERMetrics", threshold: float = 5.0
    ) -> bool:
        """
