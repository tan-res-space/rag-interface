...
class Settings:
    ...
    def __init__(self):
        ...
        self.analytics = {
            ...
            "aggregation_window_minutes": int(os.getenv("AGGREGATION_WINDOW_MINUTES", "15")),
            "quality_threshold": float(os.getenv("QUALITY_THRESHOLD", "0.8"))
        }
        
        # Database configuration
        self.database = {
            "url": os.getenv("DATABASE_URL", "postgresql://user:password@localhost:5432/verification_service"),
        ...
        # Redis configuration
        self.redis = {
            "url": os.getenv("REDIS_URL", "redis://localhost:6379/3"),  # Different DB from other services
        ...
        self.processing = {
            "max_concurrent_verifications": int(os.getenv("MAX_CONCURRENT_VERIFICATIONS", "50")),
