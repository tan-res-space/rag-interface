...
class TestErrorReportAPIEndpoints:
    ...
    def test_submit_error_report_success(self, client, auth_headers, valid_error_report_data):
        """Test successful error report submission"""
        # Act
        response = client.post(
            "/api/v1/errors",
            json=valid_error_report_data,
    ...
    def test_get_error_report_not_found(self, client, auth_headers):
        ...
        # Act
        response = client.get(
            f"/api/v1/errors/{nonexistent_id}",
            headers=auth_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_api_performance_requirements(self, async_client, auth_headers, valid_error_report_data):
