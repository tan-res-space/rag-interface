...
class TestPerformanceScenarios:
    ...
    def test_search_performance_with_large_dataset(self, client, auth_headers):
        ...
        search_scenarios = [
            ...
            {"params": {"job_id": job_id, "page": 1, "size": 10}, "description": "Job ID filter"},
            {"params": {"speaker_id": speaker_id, "page": 1, "size": 10}, "description": "Speaker ID filter"},
            {"params": {"severity_level": "high", "page": 1, "size": 10}, "description": "Severity filter"},
            {"params": {"categories": "medical_terminology", "page": 1, "size": 10}, "description": "Category filter"}
        ]
    ...
    def test_database_connection_pool_performance(self, client, auth_headers):
        ...
        def perform_db_operation():
            ...
            if submit_response.status_code == 201:
                ...
                return submit_response.status_code == 201 and get_response.status_code == 200
