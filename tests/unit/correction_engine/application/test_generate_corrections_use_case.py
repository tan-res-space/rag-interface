...
from src.correction_engine_service.application.use_cases.generate_corrections import GenerateCorrectionsUseCase
...
from src.correction_engine_service.domain.value_objects.confidence_score import ConfidenceScore
...
class TestGenerateCorrectionsUseCase:
    ...
    def mock_correction_model(self):
        ...
        mock = Mock()
        mock.generate_corrections = AsyncMock(return_value=[
    ...
    @pytest.mark.asyncio
    async def test_generate_corrections_success(self, use_case, mock_correction_model, mock_suggestion_repository):
    ...
    @pytest.mark.asyncio
    async def test_generate_corrections_with_conservative_mode(self, use_case, mock_correction_model, mock_suggestion_repository):
        ...
        mock_correction_model.generate_corrections.return_value = [high_confidence, low_confidence]
    ...
    @pytest.mark.asyncio
    async def test_generate_corrections_with_aggressive_mode(self, use_case, mock_correction_model, mock_suggestion_repository):
    ...
    @pytest.mark.asyncio
    async def test_generate_corrections_respects_max_suggestions(self, use_case, mock_correction_model, mock_suggestion_repository):
    ...
    @pytest.mark.asyncio
    async def test_generate_corrections_model_failure(self, use_case, mock_correction_model, mock_suggestion_repository):
        ...
        mock_correction_model.generate_corrections.side_effect = Exception("Model error")
    ...
    @pytest.mark.asyncio
    async def test_generate_corrections_repository_failure(self, use_case, mock_correction_model, mock_suggestion_repository):
        ...
        mock_suggestion_repository.save_suggestions.side_effect = Exception("Repository error")
    ...
    @pytest.mark.asyncio
    async def test_generate_corrections_performance_tracking(self, use_case, mock_correction_model, mock_suggestion_repository):
    ...
    @pytest.mark.asyncio
    async def test_generate_corrections_with_context(self, use_case, mock_correction_model, mock_suggestion_repository):
    ...
    @pytest.mark.asyncio
    async def test_generate_corrections_model_info_in_response(self, use_case, mock_correction_model, mock_suggestion_repository):
        """Test that model information is included in response."""
        # Arrange
        request = CorrectionRequest(
            text="Model info test",
            correction_mode=CorrectionMode.BALANCED
        )
