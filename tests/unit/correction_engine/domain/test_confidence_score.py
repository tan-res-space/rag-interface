...
class TestConfidenceScoreClassification:
    ...
    def test_is_high_confidence(self):
        ...
        # Arrange
        high_scores = [ConfidenceScore(0.9), ConfidenceScore(0.95), ConfidenceScore(1.0)]
        medium_scores = [ConfidenceScore(0.7), ConfidenceScore(0.8), ConfidenceScore(0.85)]
    ...
    def test_is_medium_confidence(self):
        ...
        medium_scores = [ConfidenceScore(0.6), ConfidenceScore(0.7), ConfidenceScore(0.85)]
...
class TestConfidenceScoreBusinessRules:
    ...
    def test_combine_mismatched_weights_raises_error(self):
        ...
        # Act & Assert
        with pytest.raises(ValueError, match="Number of weights must match number of scores"):
