...
from src.rag_integration_service.application.use_cases.generate_embedding import GenerateEmbeddingUseCase
...
from src.rag_integration_service.application.ports.secondary.ml_model_port import MLModelPort
from src.rag_integration_service.application.ports.secondary.vector_storage_port import VectorStoragePort
...
class TestGenerateEmbeddingUseCase:
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_success(self, use_case, mock_ml_model, mock_vector_storage, mock_cache):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_with_cache_hit(self, use_case, mock_ml_model, mock_vector_storage, mock_cache):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_ml_model_failure(self, use_case, mock_ml_model, mock_vector_storage, mock_cache):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_storage_failure(self, use_case, mock_ml_model, mock_vector_storage, mock_cache):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_with_different_types(self, use_case, mock_ml_model, mock_vector_storage, mock_cache):
        ...
        request_correction = EmbeddingRequest(
            ...
            embedding_type=EmbeddingType.CORRECTION
        )
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_with_custom_model_version(self, use_case, mock_ml_model, mock_vector_storage, mock_cache):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_with_complex_metadata(self, use_case, mock_ml_model, mock_vector_storage, mock_cache):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_performance_tracking(self, use_case, mock_ml_model, mock_vector_storage, mock_cache):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_text_hash_generation(self, use_case, mock_ml_model, mock_vector_storage, mock_cache):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_model_info_in_response(self, use_case, mock_ml_model, mock_vector_storage, mock_cache):
