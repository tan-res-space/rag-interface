...
class TestAuthenticateUserUseCase:
    ...
    async def test_authentication_user_not_found(
        self, use_case, mock_user_repository, mock_event_publisher, auth_request
    ):
    ...
    @pytest.mark.asyncio
    async def test_authentication_inactive_user(
        self,
        use_case,
        mock_user_repository,
        mock_event_publisher,
    ...
    @pytest.mark.asyncio
    async def test_authentication_locked_account(
        self,
        use_case,
        mock_user_repository,
        mock_event_publisher,
    ...
    @pytest.mark.asyncio
    async def test_authentication_locks_account_after_5_failures(
        self,
        use_case,
        mock_user_repository,
        mock_password_service,
    ...
    @pytest.mark.asyncio
    async def test_authentication_system_error(
        self, use_case, mock_user_repository, mock_event_publisher, auth_request
    ):
    ...
    @pytest.mark.asyncio
    async def test_authentication_updates_user_on_success(
        self,
        use_case,
        mock_user_repository,
        mock_password_service,
    ...
    @pytest.mark.asyncio
    async def test_authentication_generates_correct_tokens(
        self,
        use_case,
        mock_user_repository,
        mock_password_service,
